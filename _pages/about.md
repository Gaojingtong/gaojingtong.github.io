...
**My Expected PhD graduation:** Jun–Aug 2026. Actively seeking opportunities in **Recommender Systems**, **Ads tech** (retrieval/recall, bidding, etc.) and other **LLM-related positions** worldwide. Feel free to **reach out via [email](jt.g@my.cityu.edu.hk)**.
...
My research interest includes <u>Recommender Systems, Large Language Models, Deep Reinforcement Learning and Machine Learning</u>. I have published several papers at the top international AI conferences with [600+ citations](https://scholar.google.com/citations?user=tkis1Q0AAAAJ).
